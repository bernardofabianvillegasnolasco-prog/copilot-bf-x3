...
async function doctor(){
  console.log(`🩺 COPILOT BF x6 Doctor v${pkg.version}\n`);
...
Comandos:
  ...
  bf config Ver keys
  bf chat "pregunta" Chat 4 cerebros consenso
...
async function chat(){
  ...
  if(qFromArgs){
    console.log(`💬 BF x6 Chat: "${qFromArgs}"`);
    console.log(await runChatConsensus(qFromArgs));
    return;
  }
  console.log(`💬 COPILOT BF x6 v${pkg.version} - Chat interactivo (exit para salir)\n`);
