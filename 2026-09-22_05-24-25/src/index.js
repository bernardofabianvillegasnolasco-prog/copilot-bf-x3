...
async function status(){
  console.log(`\n🤖 COPILOT BF x4 v${pkg.version} - 4 CEREBROS`);
...
async function doctor(){
  console.log(`🩺 COPILOT BF x4 Doctor v${pkg.version}\n`);
...
async function chat(){
  ...
  console.log(`💬 COPILOT BF x4 v${pkg.version} - Chat interactivo (exit para salir)\n`);
