export async function chatBF(p){
  ...
  if(lower.includes('creador') || lower.includes('quien te creo') || lower.includes('quien te hizo') || lower.includes('dueño') || lower.includes('owner')){
    return "--- CREADOR HIGUERA ---\nMi creador y dueño absoluto es BERNARDO FABIAN VILLEGAS NOLAZCO, nacido el 01/03/1999 en La Higuera de Zaragoza donde creció. FB: BFVillegas99, IG: bfvillegas99, GitHub: BFVillegas99. De La Higuera a Utah, más arriba que lo alto. 🌵\n";
  }
